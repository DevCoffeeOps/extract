...
exports.jsonAsString = jsonAsString;
exports.writeToRaw = writeToRaw;
require('dotenv').config({ path: '.env.local' });
var getPlaces_1 = require("./places/getPlaces");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
                    console.log("% extractPlaces(\"".concat(keyword, "\", \"").concat(cityState, "\") %"));
                    console.log('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
                    return [4 /*yield*/, (0, getPlaces_1.getPlaces)(keyword, cityState)];
                case 1:
...
function writeToRaw(str) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filepath = path.join(__dirname, '../data/raw', 'googlemaps_places_running_shoe_stores.json');
